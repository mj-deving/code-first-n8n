...
- **[n8n-nodes-utcp-codemode](https://github.com/mj-deving/n8n-nodes-utcp-codemode)** — Same engine as an n8n community node
- **[Code-First n8n Proving Ground](https://github.com/mj-deving/code-mode)** — Full lifecycle thesis, POC templates, benchmarks
