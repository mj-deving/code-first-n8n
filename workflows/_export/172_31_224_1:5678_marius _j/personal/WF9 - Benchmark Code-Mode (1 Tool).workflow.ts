...
// BenchmarkAgent                     agent                      [AI]
// GeminiModel                        lmChatGoogleGemini         [creds] [ai_languageModel]
...
//
// AI CONNECTIONS
// BenchmarkAgent.uses({ ai_languageModel: GeminiModel, ai_tool: [CodeModeTool] })
// </workflow-map>
...
export class Wf9BenchmarkCodeMode1ToolWorkflow {
    // =====================================================================
